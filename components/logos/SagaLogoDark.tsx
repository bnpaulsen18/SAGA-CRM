/**
 * SAGA Logo - Monochrome Dark
 * Use case: Partner logo grids, black & white print, light backgrounds
 * Color: #0F1419 (Navy - WCAG AAA compliant on white)
 * Size: 240x80
 */

interface SagaLogoDarkProps {
  className?: string
  width?: number
  showTagline?: boolean
}

export default function SagaLogoDark({
  className = '',
  width = 220,
  showTagline = true
}: SagaLogoDarkProps) {
