...
// VERSION 2: "Impact-Focused" - Results & Social Proof Heavy
// Focus: Show concrete results, emphasize ROI and success metrics
// Selling Point: Proven platform that drives real fundraising results
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460]">
      ...
      <div className="fixed top-4 right-4 z-50 flex gap-2 bg-black/50 backdrop-blur-sm p-2 rounded-lg border border-white/20">
        ...
        <Link href="/preview/v2" className="px-3 py-1 bg-[#ff6b6b] text-white rounded text-sm font-semibold">
          V2
        </Link>
