...
/**
 * OPTION 4: "MIDNIGHT IMPACT" (HYBRID)
 *
 * DESIGN PHILOSOPHY:
 * - Combines Option 1's dark sophistication with Option 3's storytelling
 * - Split-screen layout with dark theme throughout
 * - Glassmorphic elements on both sides
 * - Purple/coral gradient accents from SAGA brand
 * - Mission-focused with social proof, but in a sleek dark aesthetic
 *
 * WHAT'S COMBINED:
 * ✓ Option 1: Dark gradient background, glassmorphism, purple accents
 * ✓ Option 3: Split-screen layout, brand storytelling, testimonials
 *
 * RESULT: Sophisticated dark theme that tells the SAGA story
 *
 * FULL CRM THEME:
 * Same as Option 1 (Midnight Professional) - dark glassmorphic throughout
 * with warm accent colors and mission-focused dashboard widgets
 */

export default function LoginOption4Hybrid() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Brand Story (Dark Theme) */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] p-12 flex-col justify-between relative overflow-hidden">
        {/* Decorative Elements */}
      ...
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-[#0f1419] via-[#1a1a2e] to-[#16213e] flex items-center justify-center p-8 relative overflow-hidden">
        {/* Subtle decorative element */}
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#764ba2] opacity-5 rounded-full blur-3xl"></div>
