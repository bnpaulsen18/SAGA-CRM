 ...
 * - Emphasizes trust, reliability, and simplicity
 * - Soft gradients and subtle shadows
 * - Clean typography with excellent readability
 *
 * FULL CRM THEME:
 * - White background with light gray (#f9fafb) sections
 * - Soft blue (#3b82f6) primary color
 * - Indigo (#6366f1) accents
 * - Subtle drop shadows for depth
 * - Clean data tables with alternating row colors
 * - Soft rounded corners throughout
 * - Green (#10b981) for success, Red (#ef4444) for alerts
 * - Sidebar with white background and subtle border
 * - Professional charts with blue color palette
 */

export default function LoginOption2Clean() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-block bg-white rounded-2xl shadow-sm p-6 mb-4">
            <Image
          ...
          <p className="text-gray-600">
            Sign in to manage your nonprofit's impact
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500">New to SAGA?</span>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 font-medium transition-all"
              >
                Create an Account
              </Link>
            </div>
